    ...
    return(
        <>
            <form className="form d-flex gap-3 mb-3" onSubmit={handleSubmit}>
                <input type="text" className="form-control" id="personNumber" placeholder="Enter number of people" value={formValue} onChange={(event) => setFormValue(event.target.value)} />
